...
The Wavey Bug Tracker (formerly Hotbug) is an issue tracker that I built in .NET, C#, PostgreSQL and MVC.  This is a powerful application that I use to work through bugs in my own projects. Enjoy this walk-through! <a href="https://hotbug-production.up.railway.app/">Go to Wavey</a>
