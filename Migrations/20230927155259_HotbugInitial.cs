...
{
    /// <inheritdoc />
    public partial class HotbugInitial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HBUserProject", x => new { x.MembersId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_HBUserProject_AspNetUsers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HBUserProject_Projects_ProjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HBUserProject_ProjectsId",
                table: "HBUserProject",
                column: "ProjectsId");
