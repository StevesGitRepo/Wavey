    ...
    public static async Task SeedDefautTicketsAsync(ApplicationDbContext context)
    {
        ...
        try
        {
            IList<Ticket> tickets = new List<Ticket>() {
                                //PORTFOLIO
                                new Ticket() {Title = "Dashboard Ticket 1", Description = "Ticket details for dashboard ticket 1", Created = DateTime.Now, ProjectId = dashboardId, TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Dashboard Ticket 2", Description = "Ticket details for dashboard ticket 2", Created = DateTime.Now, ProjectId = dashboardId, TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Dashboard Ticket 3", Description = "Ticket details for dashboard ticket 3", Created = DateTime.Now, ProjectId = dashboardId, TicketPriorityId = priorityHigh, TicketStatusId = statusDev, TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Dashboard Ticket 4", Description = "Ticket details for dashboard ticket 4", Created = DateTime.Now, ProjectId = dashboardId, TicketPriorityId = priorityUrgent, TicketStatusId = statusTest, TicketTypeId = typeDefect},
                                new Ticket() {Title = "Dashboard Ticket 5", Description = "Ticket details for dashboard ticket 5", Created = DateTime.Now, ProjectId = dashboardId, TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Dashboard Ticket 6", Description = "Ticket details for dashboard ticket 6", Created = DateTime.Now, ProjectId = dashboardId, TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Dashboard Ticket 7", Description = "Ticket details for dashboard ticket 7", Created = DateTime.Now, ProjectId = dashboardId, TicketPriorityId = priorityHigh, TicketStatusId = statusDev, TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Dashboard Ticket 8", Description = "Ticket details for dashboard ticket 8", Created = DateTime.Now, ProjectId = dashboardId, TicketPriorityId = priorityUrgent, TicketStatusId = statusTest, TicketTypeId = typeDefect},
                                //BLOG
                                ...
                                //BUGTRACKER                                                                                                                 
                                new Ticket() {Title = "Bug Tracker Ticket 1", Description = "Ticket details for bug tracker ticket 1", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 2", Description = "Ticket details for bug tracker ticket 2", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 3", Description = "Ticket details for bug tracker ticket 3", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 4", Description = "Ticket details for bug tracker ticket 4", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 5", Description = "Ticket details for bug tracker ticket 5", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 6", Description = "Ticket details for bug tracker ticket 6", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 7", Description = "Ticket details for bug tracker ticket 7", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 8", Description = "Ticket details for bug tracker ticket 8", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 9", Description = "Ticket details for bug tracker ticket 9", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 10", Description = "Ticket details for bug tracker 10", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 11", Description = "Ticket details for bug tracker 11", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Bug Tracker Ticket 12", Description = "Ticket details for bug tracker 12", Created = DateTime.Now, ProjectId = bugtrackerId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                ...
                                new Ticket() {Title = "Movie Ticket 20", Description = "Ticket details for movie ticket 20", Created = DateTime.Now, ProjectId = movieId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                      //ADDRESS BOOK
                                new Ticket() {Title = "Address Book Ticket 1", Description = "Ticket details for address book ticket 1", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeDefect},
                                new Ticket() {Title = "Address Book Ticket 2", Description = "Ticket details for address book ticket 2", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusDev, TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Address Book Ticket 3", Description = "Ticket details for address book ticket 3", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Address Book Ticket 4", Description = "Ticket details for address book ticket 4", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Address Book Ticket 5", Description = "Ticket details for address book ticket 5", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusDev,  TicketTypeId = typeDefect},
                                new Ticket() {Title = "Address Book Ticket 6", Description = "Ticket details for address book ticket 6", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusNew,  TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Address Book Ticket 7", Description = "Ticket details for address book ticket 7", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew, TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Address Book Ticket 8", Description = "Ticket details for address book ticket 8", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusDev,  TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Address Book Ticket 9", Description = "Ticket details for address book ticket 9", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusNew,  TicketTypeId = typeDefect},
                                new Ticket() {Title = "Address Book Ticket 10", Description = "Ticket details for address book ticket 10", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusNew, TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Address Book Ticket 11", Description = "Ticket details for address book ticket 11", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusDev,  TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Address Book Ticket 12", Description = "Ticket details for address book ticket 12", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew,  TicketTypeId = typeNewDev},
                                new Ticket() {Title = "Address Book Ticket 13", Description = "Ticket details for address book ticket 13", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityLow, TicketStatusId = statusNew, TicketTypeId = typeDefect},
                                new Ticket() {Title = "Address Book Ticket 14", Description = "Ticket details for address book ticket 14", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityMedium, TicketStatusId = statusDev,  TicketTypeId = typeEnhancement},
                                new Ticket() {Title = "Address Book Ticket 15", Description = "Ticket details for address book ticket 15", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityHigh, TicketStatusId = statusNew,  TicketTypeId = typeChangeRequest},
                                new Ticket() {Title = "Address Book Ticket 16", Description = "Ticket details for address book ticket 16", Created = DateTime.Now, ProjectId = addressbookId, TicketPriorityId = priorityUrgent, TicketStatusId = statusNew, TicketTypeId = typeNewDev},
