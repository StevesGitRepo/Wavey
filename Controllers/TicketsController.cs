...
namespace HotBug.Controllers
{
    ...
    public class TicketsController : Controller
    {
        ...
        private readonly IHBFileService _fileService;
        ...
        {
            HBUser itUser = await _userManager.GetUserAsync(User);

            List<Ticket> tickets = await _ticketService.GetTicketsByUserIdAsync(itUser.Id, itUser.CompanyId);
        ...
        public async Task<IActionResult> AssignDeveloper(AssignDeveloperViewModel model)
        {
            if (model.DeveloperId != null)
            {
                ...
                await _historyService.AddHistoryAsync(oldTicket, newTicket, hBUser.Id);
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                ViewData["ProjectId"] = new SelectList(await _projectService.GetUserProjectsAsync(hBUser.Id), "Id", "Name");
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Title,ProjectId,Description,Created,TicketTypeId,TicketPriorityId")] Ticket ticket)
        {
            HBUser hBUser = await _userManager.GetUserAsync(User);
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    await _historyService.AddHistoryAsync(null, newTicket, hBUser.Id);
            ...
            if (User.IsInRole(nameof(Roles.Admin)))
            {
                ViewData["ProjectId"] = new SelectList(await _projectService.GetAllProjectsByCompanyAsync(hBUser.CompanyId), "Id", "Name");
            }
            else
            {
                ViewData["ProjectId"] = new SelectList(await _projectService.GetUserProjectsAsync(hBUser.Id), "Id", "Name");
